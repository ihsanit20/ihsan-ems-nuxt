...
export type StudentEnrollment = {
  ...
  roll_no?: string | null;
  admission_type?: string | null; // admission | transfer_in | promotion | ...
  status?: string | null;
  remarks?: string | null;
...
export type Student = {
  ...
  // Guardian
  guardian_type?: "father" | "mother" | "other" | null;
  ...
  photo_url?: string | null; // if you add accessor in API
...
export type StudentFilters = {
  ...
  with?: string[]; // for index eager-load
  paginate?: boolean;
};
